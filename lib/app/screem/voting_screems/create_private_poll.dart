        ...
        child: Container(
          ...
          child: Column(
              ...
              children: [
                Center(
                  child: AppText(
                    widget.isPrivate? StringData.createPrivatePoll:StringData.createPublicPoll,
                ...
                Column(
                  ...
                  //Button add Option 
                     ...
                     child: InkWell(
                      onTap: (() {
                       ...
                       child: Container(
                        ...
                        child: AppText(StringData.addOption,color: AppColors.blueBgColor,size: 12.0,),
                       ),
                     ),
                   ),
                   ...
                   widget.isPrivate? Row(
                    mainAxisAlignment: MainAxisAlignment.spaceAround,
                    crossAxisAlignment: CrossAxisAlignment.center,
                    children: [
                    RichText(
                      text: TextSpan(children:[
                        TextSpan(text: StringData.importListVoter,style: TextStyle(color: AppColors.blackColor,fontSize: 12.0), 

                        ), 
                           TextSpan(text:'   ${StringData.excelFile}',style: TextStyle(color: AppColors.blueBgColor,fontSize: 12.0))
