        ...
        child: Center(
          child: Column(
            children: [
              ...
              Image.asset(AssetData.jouet,width: width,height: heigth*.4,),
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        DynamiqueButton(
                        childs: Icon(Icons.arrow_forward,color: AppColors.backgroundColor,size: heigth*.04,),
                        width: width*.25,
                        height: heigth*.045,
                        action: (){
                          Navigator.push(context, MaterialPageRoute(builder: (context)=>const LoginTemplateScreem()));
                        },
