...
class MyAppBar extends StatelessWidget with PreferredSizeWidget {
  ...
  const MyAppBar({super.key, required this.leadingWidget, this.nbrNotification=1});
  ...
  Widget build(BuildContext context) {
    ...
    return AppBar(
      title:badges.Badge(
        ...
        badgeContent: AppText(nbrNotification.toInt().toString(),color: AppColors.backgroundColor,),
        child: IconButton(onPressed: (){}, 
        icon: Icon(Icons.notifications_outlined,color: AppColors.blackColor,size: 35.0,)),
      )
       ,
      centerTitle: true,
      backgroundColor:AppColors.backgroundColor,
        ...
        actions: [
          InkWell(
            onTap: () {
              Navigator.push(context, MaterialPageRoute(builder: (context)=>const ProfilScreem()));
            },
            child: CircleAvatar(
              backgroundColor: AppColors.backgroundColor,
              maxRadius: height * .06,
